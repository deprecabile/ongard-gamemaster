...
public abstract class TestcontainersConfiguration {
  ...
  static final PostgreSQLContainer postgres = new PostgreSQLContainer("postgres:18.1-alpine").withDatabaseName("db-auth").withUsername("postgres").withPassword("postgres").withInitScript("tc-init-schema.sql");
